      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-border">
            ...
            <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-muted-foreground">Contracts</th>
            <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-muted-foreground">Premium Paid</th>
            ...
            <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-muted-foreground">DTE</th>
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-3 text-right">
                  {pos.pnl !== null ? (
                    <div className={cn('tabular-nums font-mono', pnlPositive ? 'text-success' : 'text-destructive')}>
                ...
                {/* Days to expiry */}
                <td className={cn('px-4 py-3 text-right tabular-nums font-mono', dteWarning ? 'text-destructive font-bold' : 'text-foreground')}>
                  {pos.daysToExpiry}
                </td>
