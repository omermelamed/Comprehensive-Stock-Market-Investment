...
import { useTelegramSchedules } from './useTelegramSchedules'
import type { ScheduledMessage, ScheduledMessageRequest } from '@/api/telegramSchedules'
...
const TYPE_COLORS: Record<string, string> = {
  ...
  PERFORMANCE_REPORT:  'bg-emerald-500/15 text-emerald-500',
