...
import com.investment.infrastructure.TelegramConversationRecord
...
class TelegramIntentClassifier(
    ...
    fun classify(
        userMessage: String,
        recentHistory: List<TelegramConversationRecord>,
        ...
        val systemPrompt = """
            You are an intent classifier for a personal investment Telegram bot.
